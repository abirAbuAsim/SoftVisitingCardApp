...
import com.example.android.softvisitingcardapp.feature.FeatureAdapter;
import com.example.android.softvisitingcardapp.feature.FeatureAddActivity;
...
public class SupplierListFragment extends Fragment {
    ...
    private void updateList(){
        ...
        Call<Suppliers> call = service.getAllSuppliers();

        call.enqueue(new Callback<Suppliers>() {
            @Override
            public void onResponse(Call<Suppliers> call, Response<Suppliers> response) {
                adapter = new SupplierAdapter(response.body().getSuppliers(), getActivity());
    ...
    private void search(SearchView searchView) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                if (adapter != null) ((SupplierAdapter) adapter).getFilter().filter(newText);
                return true;
            }
        });
    }
