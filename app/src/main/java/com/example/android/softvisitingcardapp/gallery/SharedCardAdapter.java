...
public class SharedCardAdapter extends RecyclerView.Adapter<SharedCardAdapter.ViewHolder> {
    ...
    public SharedCardAdapter(ArrayList<CardViewed> cards, Context mCtx) {
        this.cards = cards;
        this.mCtx = mCtx;
    }
    ...
    @Override
    public void onBindViewHolder(SharedCardAdapter.ViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent cardIntent = new Intent(mCtx, SharedCardDetailActivity.class);
