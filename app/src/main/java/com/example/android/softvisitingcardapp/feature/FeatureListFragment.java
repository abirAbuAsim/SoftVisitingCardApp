...
public class FeatureListFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Click action
                Intent intent = new Intent(getActivity(), FeatureAddActivity.class);
    ...
    private void updateList(){
        ...
        Call<Features> call = service.getAllFeatures();

        call.enqueue(new Callback<Features>() {
            @Override
            public void onResponse(Call<Features> call, Response<Features> response) {
                adapter = new FeatureAdapter(response.body().getFeatures(), getActivity());
    ...
    private void search(SearchView searchView) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                if (adapter != null) ((FeatureAdapter) adapter).getFilter().filter(newText);
                return true;
            }
        });
    }
